#!/usr/bin/env python
"""
MCP filesystem server exposing a notes folder (for cheatsheets, mappings, etc.).
...
SERVER_NAME = "nvim-notes"
ROOT = Path(os.environ.get("NVIM_NOTES_ROOT", Path.home() / ".config/nvim/notes")).resolve()
