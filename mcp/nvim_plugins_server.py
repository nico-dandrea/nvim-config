#!/usr/bin/env python
"""
MCP filesystem server exposing Neovim's plugin runtime tree (packer/packpath).
...
SERVER_NAME = "nvim-plugins"
ROOT = Path(
    os.environ.get("NVIM_PLUGINS_ROOT", Path.home() / ".local/share/nvim/site/pack")
).resolve()
...
INCLUDE_PATTERNS = [
    ...
    "packer/start/*/lua/**",
    "packer/start/*/plugin/**",
    "packer/start/*/ftplugin/**",
    "packer/opt/*/README*",
    "packer/opt/*/doc/**",
    "packer/opt/*/lua/**",
    "packer/opt/*/plugin/**",
    "packer/opt/*/ftplugin/**",
    # Native pack/* in case you use it too
    "*/start/*/README*",
    "*/start/*/doc/**",
    "*/start/*/lua/**",
    "*/start/*/plugin/**",
